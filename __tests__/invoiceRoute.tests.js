...
const {db} = require('../db');
const {createCompanies, createInvoices} = require('../_testData');

let tstCompany = {};
let tstInvoice = {};

beforeEach(async function(){
    let compData = await createCompanies();
        tstCompany.companies = compData.rows;
    let invData = await createInvoices();
        tstInvoice.invoices = invData.rows;
})
